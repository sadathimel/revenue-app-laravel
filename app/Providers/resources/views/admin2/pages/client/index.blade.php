                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <div class="p-2">
                                    <a class="btn btn-block bg-gradient-success" href="{{ route('client.sheet.import') }}"><i class="fas fa-file-excel"></i> Bulk Entry </a>
                                </div>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="buttons btn-group btn-group-toggle">
                                                    <a target="_blank" href="#" class="btn icon btn-primary"><i class="icon-eye-open"></i> View </a>
                                                    <a target="_blank" href="{{ route('client.edit',$client->uuid)}}" class="btn icon btn-success"><i class="fas fa-edit"></i> Update </a>
