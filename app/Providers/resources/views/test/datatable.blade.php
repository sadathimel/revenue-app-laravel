...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset('assets/admin2/plugins/fontawesome-free/css/all.min.css')}}">
    <!-- DataTables -->
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{asset('assets/admin2/dist/css/adminlte.min.css')}}">
</head>
