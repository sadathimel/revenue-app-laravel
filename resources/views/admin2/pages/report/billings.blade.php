                                    ...
                                    <div class="row">
                                        <div class="col-5">
                                            <div class="form-group">
                                                ...
                                                <select multiple name="select_client_name" id="select_client_name" class="filter-multi-select">
                                        ...
                                        <div class="col-2">
                                            <div class="form-group">
                                                ...
                                                <select multiple name="select_year" id="select_year" class="filter-multi-select">
                            ...
                            <div class="card-body">
                                ...
                                @foreach ($results as $row)
                                    <tr>
                                        <td>{{ $row->name }}</td>
                                        <td>{{ $row->year }}</td>
                                        <td>{{ ($row->january == '') ? 0 : $row->january }}</td>
