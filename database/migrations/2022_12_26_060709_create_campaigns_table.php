...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('campaigns', function (Blueprint $table) {
            ...
            $table->bigInteger('unbilled_amount')->unsigned()->default(0);
            ...
            $table->bigInteger('bill_amount')->unsigned()->default(0)->comment('after calculating vat');
            $table->string('payment_status')->default('FALSE');
            $table->bigInteger('received_amount')->unsigned()->default(0)->comment('how much amount received');
            ...
            $table->bigInteger('due')->unsigned()->default(0);
