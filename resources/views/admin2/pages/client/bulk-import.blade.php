            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form" method="POST" action="{{ route('client.import') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="client_type_option" id="client_id" style="width: 100%;">
