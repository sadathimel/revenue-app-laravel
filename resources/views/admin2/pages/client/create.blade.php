            ...
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title mx-auto text-center">Client Entry</h3>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group mandatory">
                                        ...
                                        <input type="text" id="name" class="form-control" name="name"
                                            placeholder="Ex: Analyzen Bangladesh Limited" value="{{ old('name') }}"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="email" class="form-control" name="email"
                                            value="{{ old('email') }}" placeholder="Ex: example@gmail.com">
                                        @error('email')
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="phone" class="form-control" name="phone"
                                            placeholder="Ex: 01xxxxxx" value="{{ old('phone') }}"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="vat_on"
                                                id="exampleRadios1" value="1" onclick="showCollapse()">
                                            <label class="form-check-label" for="exampleRadios1">Gross</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="vat_on"
                                                id="exampleRadios2" value="2" onclick="hideCollapse()">
